...
//        Console.WriteLine(sumRows[i]);    // Для тестирования: проверка суммы строк
    }
...
PrintMatrix(matrix);
Console.WriteLine();
int minRow = FindMinSumRowMatrix(matrix) + 1;   // +1 добавляем чтобы счёт строк начинался с 1, а не с 0
